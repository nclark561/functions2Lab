...
// CODE HERE
const asdf = (param1, param2) => console.log(`The first param is ${param1}. The second parameter is ${param2}`);
...
const greeting = (firstName, lastName, func) => {
    let fullName = func(firstName, lastName);
    console.log(`Hi I am ${fullName}`) 
}

// INVOKE 'GREETING FUNCTION' HERE
greeting('Noah', 'Clark', fullNam);
...
// CODE HERE
const taxCost = () => `The cost with taxes is ${totalCost}.`;

const pricesPlusTax = (arr, func) => {
    for (let i = 0; i < arr.length; i++) {
...
// CODE HERE
const multiplyingFactory = num => (num2) => num >= 5 ? 5 * num2 : 'cannot multiply: the first number is smaller than 5.';
