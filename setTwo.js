...
// CODE HERE
uniq(names, uniqArr => console.log(`The new names array without duplicate items is ${uniqArr}.`));
...
console.log(addSeven(16));
console.log(addSeven(25));
